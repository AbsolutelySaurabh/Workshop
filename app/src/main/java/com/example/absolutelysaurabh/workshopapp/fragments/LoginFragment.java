...
public class LoginFragment extends Fragment implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    private static final String TAG_AVAILABLE_WORLSHOPS = "AvailableWorkshopsFragment";
    ...
    public void initializeViews(){
        ...
        inputEmail = (EditText) loginFragment.findViewById(R.id.email);
        inputPassword = (EditText) loginFragment.findViewById(R.id.password);
        progressBar = (ProgressBar) loginFragment.findViewById(R.id.progressBar);
        btnSignup = (Button) loginFragment.findViewById(R.id.btn_signup);
                        ...
                        .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    //if success, Initially land to DashboardScreen
                                    Fragment fragment = new DashboardFragment();
                                    //replacing the fragment
                                    if (fragment != null) {
                                        FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
                                        ft.replace(R.id.content_frame, fragment);
                                        //remove login fragment form backstack
                                        FragmentManager fm = getActivity().getSupportFragmentManager();
                                        fm.popBackStack (TAG_AVAILABLE_WORLSHOPS, FragmentManager.POP_BACK_STACK_INCLUSIVE);
                                        ft.commit();
                                    }
                                }
                            }
        ...
        // Assign fields
        mSignInButton = (SignInButton) loginFragment.findViewById(R.id.google_sign_in_button);
